...
// Local analytics-role ranking hooks used by rank-pipeline.mjs. Full JD
// evaluation still happens later; this is intentionally title/location based.
...
export function scoreOfferFit(offer) {
  ...
  if (/\bprincipal\b|\bstaff\b|\blead\b/i.test(title)) {
    score -= 20;
    reasons.push('senior IC/title drift penalty');
  }
